...
var imageData = {};
var imageDataKeys = [];
selectedBrands = 'great|massive|huge|75in|85in';
...
function loadData() {
  get('brand_counts.json', function(data) {
    ...
    brandCounts = [
    {x: "GreatTV", value: brandCountsHolder["GreatTV"]},
    {x: "MassiveTV", value: brandCountsHolder["MassiveTV"]},
    {x: "HugeTV", value: brandCountsHolder["HugeTV"]},
    {x: "75inchTV", value: brandCountsHolder["75inchTV"]},
    {x: "85inchTV", value: brandCountsHolder["85inchTV"]}
];
  })    
...
function addWindowEventListeners() {
  ...
  window.addEventListener('hashchange', function(e) {
    ...
    marker.XPos = (((coords.x - 22140)/(33980 - 22140)) * 300) - (marker.Width / 2);
    marker.YPos = (193 - ((coords.y - 33168)/(41072 - 33168)) * 193) - marker.Height;
    ...
    clusterCounts = [
    {x: "GreatTV", value: thisClusterData["GreatTV"]},
    {x: "MassiveTV", value: thisClusterData["MassiveTV"]},
    {x: "HugeTV", value: thisClusterData["HugeTV"]},
    {x: "75inchTV", value: thisClusterData["75inchTV"]},
    {x: "85inchTV", value: thisClusterData["85inchTV"]}
    ]
...
mapSprite.src = "assets/images/Super Big Full Map.png";
